...
| `TOKEN_OPTIMIZER_REDACT_PATTERNS_FILE` | `<platform-home>/token-optimizer/redact-patterns.json` | Path to a JSON file of extra credential redaction patterns, added to the built-in set. See [Data and privacy](/reference/data-and-privacy/#custom-redaction-patterns) |
